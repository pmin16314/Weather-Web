...
const SunRiseSet = ({ data }) => {
  ...
  return (
    <div className="  bg-cardColor  dark:bg-darkCardColor rounded-[10px] h-[200px] p-[1.5rem] ">
      ...
      <div className="grid grid-cols-2 mt-[20px]">
        ...
        <div className="flex flex-row space-x-3 justify-self-start">
          ...
          <div>
            {" "}
            <p className="font-bold text-[20px] text-secondary dark:text-darkSecondary"> Sunrise</p>
            <p className="font-medium text-[50px] text-primary dark:text-white leading-none">
              {" "}
              {sunriseTime}
            </p>
          </div>
        ...
        <div className="flex flex-row space-x-3 justify-self-start">
          ...
          <div>
            {" "}
            <p className="font-bold text-[20px] text-secondary dark:text-darkSecondary"> Sunset</p>
            <p className="font-medium text-[50px] text-primary dark:text-white leading-none">
              {" "}
              {sunsetTime}
            </p>
